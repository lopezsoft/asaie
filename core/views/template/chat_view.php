...
<head>
	...
	<link rel="shortcut icon" href="assets/images/SME-logo.png" type="image/x-icon">
	<meta name="description" content="ASAIE EXODO">
	<meta name="robots" content="index,follow">
	<title> SUPPORT ASAIE - SISTEMA ACADEMICO PARA LA GESTION ESCOLAR Y ADMINISTRATIVA</title>
				...
				<div class="mbr-navbar__column mbr-navbar__column--s mbr-navbar__brand">
                    <span class="mbr-navbar__brand-link mbr-brand mbr-brand--inline">
                        <span class="mbr-brand__logo">
							<a href="">
								<img class="mbr-navbar__brand-img mbr-brand__img" src="<?php echo  base_url();?>assets/images/SME-logo.png" alt="SME ESCOLAR">
							</a>
						</span>
                        <span class="mbr-brand__name">
							<a class="mbr-brand__name text-white" href="#menu-20">ASAIE - SUPPORT</a>
						</span>
                    </span>
				</div>
						...
						<div class="mbr-navbar__column">
							<ul class="mbr-navbar__items mbr-navbar__items--right mbr-buttons mbr-buttons--freeze mbr-buttons--right btn-decorator mbr-buttons--active">
								<li class="mbr-navbar__item">
									<a class="mbr-buttons__link btn text-white" href="<?php echo base_url();?>">INICIO</a>
								</li>
							</ul>
						</div>
						<div class="mbr-navbar__column">
...
<!-- Interfaz Docente -->
<section class="mbr-box mbr-section mbr-section--relative mbr-section--fixed-size mbr-section--full-height mbr-section--bg-adapted mbr-parallax-background" id="header1-22" style="background-image: url(../../../assets/images/support1.png);">
