...
Ext.define('Admin.Application', {
    ...
    launch: function() {
        ...
        var me = this;
        cUrl = Global.getUrlBase() + 'login/check_session';
        // Ext.require('Admin.view.main.MainController');
        Ext.onReady(function() {
            ...
            Ext.Ajax.request({
                ...
                success: function(response) {
                    ...
                    msg = (Global.getData().user) ? (Global.getData().user) : '';
                ...
                failure: function(response) {
                    ...
                    // me.onOpenUrl(Global.getUrlLocation());
                }
            });
        });
    },
